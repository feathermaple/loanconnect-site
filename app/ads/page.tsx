...
export default async function AdsPage() {
  ...
  const isEmpty = paidList.length === 0 && ads.length === 0;
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                      {item.phone && (
                        <a
                          href={`tel:${item.phone}`}
                          className="rounded-full bg-[#2f2a25] px-5 py-2.5 text-sm font-bold text-white transition hover:opacity-90"
                        >
                          電話聯絡
                        </a>
                      )}
                      ...
                      {item.line_id && (
                        <div className="rounded-full border border-[#06C755]/30 bg-[#06C755]/10 px-5 py-2.5 text-sm font-bold text-[#078f3f]">
                          LINE：{item.line_id}
                        </div>
                      )}
                    </div>
                ...
                >
                  ...
                  <div className="mt-5 flex flex-wrap gap-3 text-sm">
                    {item.phone && (
                      <a
                        href={`tel:${item.phone}`}
                        className="rounded-full bg-[#2f2a25] px-4 py-2 font-bold text-white transition hover:opacity-90"
                      >
                        電話聯絡
                      </a>
                    )}
                    ...
                    {item.line_id && (
                      <div className="rounded-full border border-[#06C755]/30 bg-[#06C755]/10 px-4 py-2 font-bold text-[#078f3f]">
                        LINE：{item.line_id}
                      </div>
                    )}
                  </div>
